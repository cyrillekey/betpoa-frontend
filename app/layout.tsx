          ...
          <SimpleGrid columns={7}>
            <GridItem colSpan={1}>
              ...
              >
                  ...
                  <div className="nav__left__item">
                    <ul className="nav nav--vertical">
                      <li className="nav-item">
                        <Link
                          className={`nav-link ${
                            pathname == "/markets/football" && "active"
                          }`}
                          href="/markets/football"
                        >
                          <svg viewBox="0 0 24 24">
                            <path
                              fill="currentColor"
                      ...
                      <li className="nav-item">
                        <Link
                          className={`nav-link ${
                            pathname == "/markets/badminton" && "active"
                          }`}
                          href="/markets/badminton"
                        >
                          <svg viewBox="0 0 24 24">
                            <path
                              fill="currentColor"
                      ...
                      <li className="nav-item">
                        <Link
                          className={`nav-link ${
                            pathname == "/markets/volleyball" && "active"
                          }`}
                          href="/markets/volleyball"
                        >
                          <svg viewBox="0 0 24 24">
                            <path
                              fill="currentColor"
                      ...
                      <li className="nav-item">
                        <Link
                          className={`nav-link ${
                            pathname == "/markets/tabletennis" && "active"
                          }`}
                          href="/markets/tabletennis"
                        >
                          <svg viewBox="0 0 24 24">
                            <path
                              fill="currentColor"
                      ...
                      <li className="nav-item">
                        <Link
                          className={`nav-link ${
                            pathname == "/markets/esports" && "active"
                          }`}
                      ...
                      <li className="nav-item">
                        <Link
                          className={`nav-link ${
                            pathname == "/markets/archery" && "active"
                          }`}
                          href="/markets/archery"
                        >
                          <svg viewBox="0 0 24 24">
                            <path
                              fill="currentColor"
                      ...
                      <li className="nav-item">
                        <Link
                          className={`nav-link ${
                            pathname == "/markets/handball" && "active"
                          }`}
                          href="/markets/handball"
                        >
                          <svg viewBox="0 0 24 24">
                            <path
                              fill="currentColor"
                      ...
                      <li className="nav-item">
                        <Link
                          className={`nav-link ${
                            pathname == "/markets/basketball" && "active"
                          }`}
                          href="/markets/basketball"
                        >
                          <svg viewBox="0 0 24 24">
                            <path
                              fill="currentColor"
                ...
                <button
                  className="btn btn--icon btn--primary btn--round-lg btn--add"
